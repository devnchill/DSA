...
// Easy
// 3 pt.
// You are given an integer n denoting the number of floors in a building, where
// the floors are numbered from 0 to n - 1.
//
// You are also given an integer array requests, where requests represents the
// sequence of floor requests.
//
...
// After serving a request, the elevator immediately starts moving toward the
// next request. Return the total time (in seconds) required to serve all
// requests.
//
//  
//
...
int main() {
  ...
  cout << s.elevatorRequests(3, requests);
}
