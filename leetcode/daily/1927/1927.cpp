...
// 2+4+3 != 8+0+3. Assuming Alice and Bob play optimally, return true if Alice
// will win and false if Bob will win.
//
//
//
// Example 1:
...
// impossible for Bob to make the sums equal. Example 3:
//
// Input: num = "?3295???"
// Output: false
