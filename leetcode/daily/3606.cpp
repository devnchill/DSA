...
0-9) and underscores (_). businessLine[i] is one of the following four
categories: "electronics", "grocery", "pharmacy", "restaurant". isActive[i] is
true. Return an array of the codes of all valid coupons, sorted first by their
...
private:
  ...
  bool check_businessLine(const string &businessLine) {
    static unordered_set<string> types = {"electronics", "grocery", "pharmacy",
                                          "restaurant"};
    return types.count(businessLine);
  }
