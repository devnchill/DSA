...
// [["name","bob"],["age","two"]] Output: "bobistwoyearsold" Explanation: The
// key "name" has a value of "bob", so replace "(name)" with "bob". The key
// "age" has a value of "two", so replace "(age)" with "two". Example 2:
//
