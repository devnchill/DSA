...
// Example 1:
//
// Input: words = ["abcd","def","xyz"], weights =
...
// Explanation:
//
// The weight of "abcd" is 5 + 3 + 12 + 14 = 34. The result modulo 26 is 34 % 26
// = 8, which maps to 'r'. The weight of "def" is 14 + 1 + 2 = 17. The result
// modulo 26 is 17 % 26 = 17, which maps to 'i'. The weight of "xyz" is 7 + 7 +
// 2 = 16. The result modulo 26 is 16 % 26 = 16, which maps to 'j'. Thus, the
// string formed by concatenating the mapped characters is "rij".
//
// Example 2:
//
// Input: words = ["a","b","c"], weights =
...
// Explanation:​​​​​​​
//
// The weight of "abcd" is 7 + 5 + 3 + 4 = 19. The result modulo 26 is 19 % 26 =
// 19, which maps to 'g'.
//
