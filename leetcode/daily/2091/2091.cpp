...
// front and 3 elements from the back. This results in 2 + 3 = 5 deletions,
// which is the minimum number possible. Example 2:
//
...
// front. This results in only 3 deletions, which is the minimum number
// possible. Example 3:
//
// Input: nums = [101]
// Output: 1
...
int main() {
  Solution s;
  vector<int> nums = {-87, 60, -30, -67, 74, 55, 76, -53};
