...
program to find the higher bound of x. Example 1: Input Format: N = 4, arr[] =
...
class Solution {
public:
  int find_higher_bound(std::vector<int> nums, int target) {
    int low = 0;
...
int main(int argc, char *argv[]) {
  ...
  std::cout << s.find_higher_bound(nums, 3);
  return 0;
}
